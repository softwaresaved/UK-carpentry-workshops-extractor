...
class TestAnalyseWorkshops(object):
    ...
    def test_df_workshops_per_institution(self):
        df_workshops_per_institution = aw.workshops_per_institution_analysis(pytest.df_global_workshops,
    ...
    def test_df_workshops_per_type_year(self):
        df_workshops_per_type_year = aw.workshops_of_different_types_over_years_analysis(pytest.df_global_workshops,
                                                                                         pytest.writer_workshops)
    ...
    def test_df_attendees_per_workshop_type(self):
        df_attendees_per_workshop_type = aw.attendees_per_workshop_type_analysis(pytest.df_global_workshops,
                                                                                 pytest.writer_workshops)
    ...
    def test_df_attendees_per_workshop_type_over_years(self):
        df_attendees_per_workshop_type_over_years = aw.attendees_per_workshop_type_over_years_analysis(
