...
class TestAnalyseWorkshops(object):
    ...
    #
    # ## Assert if workshop type column was added
    # def test_workshop_type(self):
    #     assert {'tags'}.issubset(pytest.df_global_workshops)
    #
    # ## Assert if workshop institution column was added
    # def test_workshop_institution(self):
    #     assert {'workshop_institution'}.issubset(pytest.df_global_workshops)
    #
    # ## Assert if 'cancelled' and 'stalled' workshops are removed
    # def test_removed_stopped_workshops(self):
    ...
    #     df_workshops_per_institution = aw.workshops_per_host_analysis(pytest.df_global_workshops,
    #                                                                   pytest.writer_workshops)
    ...
    #     df_workshops_type = aw.workshops_per_type_analysis(pytest.df_global_workshops, pytest.writer_workshops)
    ...
    #     df_workshops_per_venue_year = aw.workshops_per_institution_over_years_analysis(pytest.df_global_workshops,
    #                                                                                    pytest.writer_workshops)
    #     assert not df_workshops_per_venue_year.empty
    #
    # ## Assert if dataframe is not empty and value for a specific year
    # def test_df_workshops_per_type_year(self):
    #     df_workshops_per_type_year = aw.workshops_per_type_per_year_analysis(pytest.df_global_workshops,
    #                                                                          pytest.writer_workshops)
    #     assert not df_workshops_per_type_year.empty
    #
    # ## Assert if dataframe is not empty and value for a specific year
    # def test_df_attendees_per_year(self):
    #     df_attendees_per_year = aw.attendance_per_year_analysis(pytest.df_global_workshops, pytest.writer_workshops)
    ...
    #     df_attendees_per_workshop_type = aw.attendance_per_type_analysis(pytest.df_global_workshops,
    #                                                                      pytest.writer_workshops)
    ...
    #     df_attendees_per_workshop_type_over_years = aw.attendance_per_type_per_year_analysis(
    #         pytest.df_global_workshops, pytest.writer_workshops)
