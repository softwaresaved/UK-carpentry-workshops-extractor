...
def pytest_namespace():
    ...
    writer_workshops = helper.create_excel_analyses_spreadsheet(file_name_workshops_without_extension,
    ...
    df_instructor_affiliation_region = helper.load_data_from_csv(file_path_instructors,
                                                                 ['affiliation', 'nearest_airport_code'])
    df_instructor_affiliation_region = helper.drop_null_values_from_columns(df_instructor_affiliation_region,
                                                                            ['affiliation', 'nearest_airport_code'])
    df_instructor_affiliation_region = helper.fix_UK_academic_institutions_names(df_instructor_affiliation_region)
    df_instructorUKregion = mapiaUK.add_region_column(df_instructor_affiliation_region, all_uk_institutions_coords_df,
                                                      regions)
